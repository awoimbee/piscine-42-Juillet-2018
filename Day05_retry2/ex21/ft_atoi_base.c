...
/*   Updated: 2018/07/09 14:11:28 by awoimbee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

int		str_to_int(char *input, long int coeff, int base_coeff, char *base)
{
	int		return_nb;
	int		digit;
...
int		allowed_char(char tested, char *base, int check_duplicate)
{
	int i;
